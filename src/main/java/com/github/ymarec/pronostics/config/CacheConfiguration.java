package com.github.ymarec.pronostics.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.github.ymarec.pronostics.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.github.ymarec.pronostics.domain.Authority.class.getName(), jcacheConfiguration);
